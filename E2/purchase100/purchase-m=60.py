...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='purchase100', help='dataset used for training')  
    ...
    parser.add_argument('--m', type=int, default=60,  help='number of clients')
    ...
    parser.add_argument('--num_epochs', type=int, default=240, help='number of maximum communication roun') 
