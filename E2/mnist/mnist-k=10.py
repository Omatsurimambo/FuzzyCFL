...
def get_args():
    ...
    parser.add_argument('--lr', type=float, default=0.015, help='learning rate (default: 0.01)')   
    ...
    parser.add_argument('--LR_DECAY', type=bool, default=True, help='Whether the learning rate is decreasing')
