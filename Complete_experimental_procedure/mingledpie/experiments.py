...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='fmnist', help='dataset used for training') #dataset
    ...
    parser.add_argument('--isomerism', type=bool, default=False, help='heterogeneous') 
