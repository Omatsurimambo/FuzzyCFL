...
class SimpleConvNetCIFAR100(nn.Module):
    def __init__(self):
        super(SimpleConvNetCIFAR100, self).__init__()
        self.conv1 = nn.Conv2d(3, 64, kernel_size=5, padding=2)
        self.conv2 = nn.Conv2d(64, 64, kernel_size=5, padding=2)
        self.pool = nn.MaxPool2d(3, stride=2, padding=1)
        self.norm = nn.LocalResponseNorm(4)
...
class MLPModelTexas(nn.Module):
    def __init__(self):
        super(MLPModelTexas, self).__init__()
...
class MLPModelPur(nn.Module):
    def __init__(self):
        super(MLPModelPur, self).__init__()
